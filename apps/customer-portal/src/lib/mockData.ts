// Mock data for BSM Platform Customer Portal
...
export const mockNotifications: Notification[] = [
  {
    ...
    user_id: '2',
    title: 'Ticket Update',
    message: 'Your server performance ticket has been updated.',
    type: 'Info',
    read: false,
  ...
  },
  {
    ...
    message: 'Your Office 365 licenses will expire in 30 days.',
    type: 'Warning',
    read: false,
    action_url: '/assets/2',
