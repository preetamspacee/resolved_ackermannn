              ...
              {categories.map((category) => {
                ...
                return (
                  <button
                    key={category.id}
                    type="button"
                    onClick={() => setFormData(prev => ({ ...prev, category: category.id as CreateTicketData['category'] }))}
              ...
              {priorities.map((priority) => {
                ...
                return (
                  <button
                    key={priority.id}
                    type="button"
                    onClick={() => setFormData(prev => ({ ...prev, priority: priority.id as CreateTicketData['priority'] }))}
