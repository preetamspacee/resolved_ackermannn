-- BSM Platform - FIXED Database Schema
-- This handles existing tables by adding missing columns
...
CREATE TABLE tickets (
    ...
    priority VARCHAR(50) NOT NULL CHECK (priority IN ('Low', 'Medium',
    'High', 'Critical')),
    category VARCHAR(255),
...
INSERT INTO users (id, name, email, role, phone, department) VALUES
  ...
  ('22222222-2222-2222-2222-222222222222', 'John Doe', 'john.doe@techcorp.com', 'Customer', '+1-555-0102', 'Engineering'),
