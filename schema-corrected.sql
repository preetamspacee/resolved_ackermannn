-- Corrected BSM Platform Database Schema
-- This schema avoids UUID casting issues by using gen_random_uuid()
...
-- Insert sample data using gen_random_uuid()
...
-- Insert sample tickets (will reference the users we just created)
