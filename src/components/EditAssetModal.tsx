...
export default function EditAssetModal({ isOpen, onClose, asset, onUpdateAsset }: EditAssetModalProps) {
  ...
  useEffect(() => {
    if (asset) {
      setFormData({
        ...
        category: asset.category || 'Infrastructure',
        ...
        cost: asset.cost ? asset.cost.replace('$', '').replace(',', '') : '',
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-2xl max-w-6xl w-full h-[90vh] overflow-hidden flex flex-col">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-green-100">Step {currentStep} of {totalSteps} - {stepTitles[currentStep - 1]}</p>
              </div>
            </div>
            <button
              onClick={onClose}
        ...
        {/* Content */}
        <div className="p-6 overflow-y-auto flex-1 pb-4">
          {/* Error Summary */}
